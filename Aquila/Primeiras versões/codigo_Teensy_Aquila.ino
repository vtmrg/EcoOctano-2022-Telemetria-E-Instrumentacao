...
#define TEMPOATT3 4000   

const int OLED_RESET = -1, pinoInterrupt = 3;
const byte SCREEN_WIDTH = 128, SCREEN_HEIGHT = 64;         
int i_vel=0, dado1,dado2;
float t0=0,tempo_p0 =0,comprimento=0, periodo=0,circunferencia=1.445,velocidade_display=0,velocidade =0, tempo=0;
char buffer[50];
String mensagem;
...
void loop(){
  ...
  if(velocidade_display<10.00) { 
     mensagem="0"+String(velocidade_display) ;
    ...
    Serial1.flush(); 
     ...
     mensagem=String(velocidade_display) ;
    Serial.print("mensgaem:");
    Serial.print(mensagem); 
    Serial1.print(mensagem); //comunicação com o esp
    Serial1.flush(); 
...
display.println(dado_velocidade);
